...
Historical acceptance for the fixes retained in 0.2.3.10. The 0.3.3 release and tag
were removed after the numbering change; see the [current validation](thermalforgepro-0.2.3.10-validation.md).
