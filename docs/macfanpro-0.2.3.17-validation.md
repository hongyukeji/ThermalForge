...
- [Homebrew CI](https://github.com/macfanpro/homebrew-tap/actions/runs/35973857050) 通过。Homebrew 从 0.2.3.16 升级到 0.2.3.17，`brew test` 通过，旧版本已从 Cellar 清理；按先退出应用、同步后台、再打开的步骤安装后，后台服务 CLI、应用与 Homebrew 版逐字节一致，版本均为 0.2.3.17，当日日志 0 条 ERROR。
