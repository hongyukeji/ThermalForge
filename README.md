...
This fork builds **0.2.3.8**, following official main (`8a344f6`). It keeps the hardware-verified M4 slow-handoff repair, checked fan handback, isolated persistence tests, and GUI support for English, Simplified Chinese and Traditional Chinese. The menu bar, app lifecycle, profile Picker, Smart algorithm, wake recovery, sensors, 100ms sampling and 95°C threshold follow upstream. Menu width changes naturally with temperature digits.

The [0.2.3.8 spacing update](docs/menu-spacing-20260921.md) aligns section and footer spacing in the native panel.
