...
当前实机验证以 M4 Max MacBook Pro 为主。其他机型、macOS 版本和显示环境不应视为已验证，具体范围见 [0.2.3.19 验证记录](docs/macfanpro-0.2.3.19-validation.md)。
...
```bash
cd ~/Downloads/MacFanPro-0.2.3.19-macos-arm64
...
菜单中还可切换温度单位、登录时启动和语言，并查看当前版本号。繁体中文使用与简体中文相同的表述，仅转换字形。
