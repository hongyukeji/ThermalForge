...
class AppDelegate: NSObject, NSApplicationDelegate {
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let bundleID = Bundle.main.bundleIdentifier ?? "io.github.hongyukeji.thermalforgepro.app"
    ...
    func applicationWillTerminate(_ notification: Notification) {
        ...
        // ONLY if the app owns the hold. A CLI hold (`sudo thermalforgepro max`) is the
...
struct MenuBarLabel: View {
    ...
    var body: some View {
        ...
        .help(language.text("ThermalForgePro: {reading}", ["reading": accessibleReading]))
        .accessibilityElement(children: .ignore)
        .accessibilityLabel("ThermalForgePro")
